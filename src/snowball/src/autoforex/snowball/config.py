...
from autoforex.core import MarginRate, Money, Percent, Pips, StrategyParameters, Units

from autoforex.snowball.config_parsing import SnowballConfigParser
from autoforex.snowball.config_serialization import SnowballConfigSerializer
from autoforex.snowball.enums import (
...
class BalanceBasedPositionSizingConfig:
    ...
    def rounded(self, units: Units) -> Units:
        ...
        rounded_units = (units / self.round_step_units).to_integral_value(
