...
from autoforex.core import CurrencyPair, Metadata, Money, ProfitMetric, new_uuid
...
class TestCloudWatchMetricStore:
    def test_publishes_profit_metrics_with_operational_dimensions(self) -> None:
